...
let modulePaths = {
 ...
 "packages/demo/main": "packages/demo/main.ddc",
 "packages/demo/main_web_entrypoint": "packages/demo/main_web_entrypoint.ddc",
 "packages/demo/models/Tree": "packages/demo/models/Tree.ddc",
 "packages/demo/pages/add_record_page/add_record_page": "packages/demo/pages/add_record_page/add_record_page.ddc",
 "packages/demo/pages/comment_page/comment": "packages/demo/pages/comment_page/comment.ddc",
 "packages/demo/pages/list_tree_page/add_tree": "packages/demo/pages/list_tree_page/add_tree.ddc",
 "packages/demo/pages/list_tree_page/edit_tree": "packages/demo/pages/list_tree_page/edit_tree.ddc",
 "packages/demo/pages/list_tree_page/list_tree_tab": "packages/demo/pages/list_tree_page/list_tree_tab.ddc",
 "packages/demo/pages/login_signup_page/HomePage": "packages/demo/pages/login_signup_page/HomePage.ddc",
 "packages/demo/pages/login_signup_page/RootPage.": "packages/demo/pages/login_signup_page/RootPage..ddc",
 "packages/demo/pages/login_signup_page/login_signup_page": "packages/demo/pages/login_signup_page/login_signup_page.ddc",
 "packages/demo/pages/search_tree_page/SearchPage": "packages/demo/pages/search_tree_page/SearchPage.ddc",
 "packages/demo/services/FirestoreService": "packages/demo/services/FirestoreService.ddc",
 "packages/demo/services/authentication": "packages/demo/services/authentication.ddc",
 ...
 "packages/quiver_hashcode/hashcode": "packages/quiver_hashcode/hashcode.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/demo/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:demo/main_web_entrypoint.dart") {
          // Clear static caches.

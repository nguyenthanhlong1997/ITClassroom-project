define(['dart_sdk', 'packages/demo/main'], function(dart_sdk, packages__demo__main) {
  'use strict';
  ...
  const main = packages__demo__main.main;
  ...
  dart.trackLibraries("packages/demo/main_web_entrypoint", {
    "package:demo/main_web_entrypoint.dart": main_web_entrypoint
  }, {

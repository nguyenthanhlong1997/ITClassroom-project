define(['dart_sdk', 'packages/quiver_hashcode/hashcode', 'packages/flutter/src/gestures/arena'], function(dart_sdk, packages__quiver_hashcode__hashcode, packages__flutter__src__gestures__arena) {
  'use strict';
  ...
  const hashcode = packages__quiver_hashcode__hashcode.hashcode;
  ...
  firebase_options.FirebaseOptions = class FirebaseOptions extends core.Object {
    ...
    get hashCode() {
      return hashcode.hashObjects(JSArrayOfString().of([this.apiKey, this.bundleID, this.clientID, this.trackingID, this.gcmSenderID, this.projectID, this.androidClientID, this.googleAppID, this.databaseURL, this.deepLinkURLScheme, this.storageBucket]));
    }
    toString() {
  ...
  platform_firebase_app.PlatformFirebaseApp = class PlatformFirebaseApp extends core.Object {
    ...
    get hashCode() {
      return hashcode.hash2(this.name, this.options);
    }
    toString() {
